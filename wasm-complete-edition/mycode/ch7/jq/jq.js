...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5573168,
    DYNAMIC_BASE = 5573168,
    DYNAMICTOP_PTR = 330032;
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=330080;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 330176, 4), 330176);function _gmtime_r(time, tmPtr) {
